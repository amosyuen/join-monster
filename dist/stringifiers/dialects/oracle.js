...
function keysetPagingSelect(expressions, table, whereCondition, order, limit, as, options = {}) {
  ...
  order = (0, _shared.orderColumnsToString)(order, q);
  if (joinCondition) {
    return `\
...
const dialect = module.exports = _extends({}, require('./pg'), {
  ...
  handleJoinedOneToManyPaginated: (() => {
    var _ref2 = _asyncToGenerator(function* (parent, node, context, expressions, tables, joinCondition) {
    ...
    return function handleJoinedOneToManyPaginated(_x6, _x7, _x8, _x9, _x10, _x11) {
  ...
  handleJoinedManyToManyPaginated: (() => {
    var _ref3 = _asyncToGenerator(function* (parent, node, context, expressions, tables, joinCondition1, joinCondition2) {
      ...
      if (node.sortKey || node.junction.sortKey) {
        const { limit, order, whereCondition: whereAddendum } = (0, _shared.interpretForKeysetPaging)(node, dialect, expressions);
        pagingWhereConditions.push(whereAddendum);
        tables.push(keysetPagingSelect(expressions, node.junction.sqlTable, pagingWhereConditions, order, limit, node.junction.as, lateralJoinOptions));
        ...
        tables.push(offsetPagingSelect(expressions, node.junction.sqlTable, pagingWhereConditions, order, limit, offset, node.junction.as, lateralJoinOptions));
      }
    });

    return function handleJoinedManyToManyPaginated(_x12, _x13, _x14, _x15, _x16, _x17, _x18) {
      return _ref3.apply(this, arguments);
    };
  })(),

  handleBatchedOneToManyPaginated: (() => {
    var _ref4 = _asyncToGenerator(function* (parent, node, context, expressions, tables, batchScope) {
    ...
    return function handleBatchedOneToManyPaginated(_x19, _x20, _x21, _x22, _x23, _x24) {
      return _ref4.apply(this, arguments);
    };
  })(),

  handleBatchedManyToManyPaginated: (() => {
    var _ref5 = _asyncToGenerator(function* (parent, node, context, expressions, tables, batchScope, joinCondition) {
    ...
    return function handleBatchedManyToManyPaginated(_x25, _x26, _x27, _x28, _x29, _x30, _x31) {
